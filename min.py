...
# Fujnção limpar tela.
def limpar_tela():
    # Foi colocado global apra que também todas as váriaveis todos_valores tenham o memso resultado.
    global todos_valores
    todos_valores = ''
    valor_texto.set('')
...
b_1 = Button(frame_corpo, height=2, width=11, command= limpar_tela, text="C", bg=cor4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b_13 = Button(frame_corpo, height=2, width=5, command= lambda: entrar_valores('2'), text="2", bg=cor4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_13.place(x=60, y=156)
b_14 = Button(frame_corpo, height=2, width=5, command= lambda: entrar_valores('3'), text="3", bg=cor4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b_18 = Button(frame_corpo, height=2, width=5, command= calcular, text="=", bg=cor4, font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
